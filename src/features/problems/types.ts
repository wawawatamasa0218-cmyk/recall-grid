...
export type Card = { id: string; userId: string; deckId: string; front: string; back: string; explanation: string; tags: string[]; imageUrl?: string; nextReviewAt: string; createdAt: string; deck?: { name: string } | null };
